...
With Markdown, you're essentially starting over and
...
After working extensively with LLMs to generate Great Tables code, I've begun to figure out what works well and what doesn't. The key is being specific about what you want while leveraging the compositional nature of the API. Here are some of the strategies that worked for me in producing the best results:
...
4. iterate compositionally: start simple, then ask for additions like `"Now add a title and source note"`

5. leverage nanoplots: if you have time-series or trend data, explicitly ask for sparklines with `"Add a trend column using fmt_nanoplot"`
