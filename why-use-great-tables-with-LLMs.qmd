...
We've created a full evaluation notebook that demonstrates this workflow: [`chatlas-eval-analysis.qmd`](chatlas-eval-analysis.qmd)
...
Check out the full notebook to see how to define test prompts for different complexity levels, how to programmatically generate and test code with chatlas. Plus it shows you how to present the results using Great Tables itself, which looks very nice.
